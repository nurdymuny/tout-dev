...
function initTabs() {
	...
	$('#header ul.btn-block').contentTabs({
		addToParent: true,
		tabLinks: 'a',
		onInit: function(tabset, tabLinks, options){
			tabLinks.each(function(ind){
...
function initChangeState(){
	...
	$('#header .header-section .block').each(function(){
		var box = $(this),
